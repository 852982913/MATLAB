...
path='D:\读研\实验数据\灌水论文\2021.12.22中心波长1560nm的谱宽变化\自相关';
...
%     plot(t,max(i)/2,'.','color','r');%中间画一条半高宽横线
    temh=t(col_daikuan);
    temz=i(col_daikuan);
    ...
    cd('D:\读研\实验数据\灌水论文\2021.12.22中心波长1560nm的谱宽变化\自相关\csv_image');    %把当前工作目录切换到指定文件夹
    f = getframe(gcf);
