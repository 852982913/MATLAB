...
path = 'C:\Users\wc852\Desktop\20220701\1\1 2022-07-01 17-10-20 0';           %添加数据文件夹绝对路径,工作区间要在同一个盘内
...
tem=(size(D,1))*10/20;%分成两个子矩阵，分别寻峰
D1=D(1:tem,:);
D2=D(tem:end,:);
hold on
...
b3=sort(a3,'descend');
b3=b3(2);
[raw3,col3]=find(D2==b3);
heng3=D2(raw3,1);
heng3=heng3(1);
zong3=b3;
plot(heng3,zong3,'.','color','r','MarkerSize',20);%峰值红点
...
% fengzhi(i,3)=str;
 ...
 cd('C:\Users\wc852\Desktop\20220701\1\1 2022-07-01 17-10-20 0\csv_image');    %把当前工作目录切换到指定文件夹
 f = getframe(gcf);
