...
shijian=csvread('C:\Users\wc852\Desktop\123.csv');
...
text(1,39.2342,txt1,'fontsize',15,'fontweight','bold','fontname','微软雅黑','Color','k')
text(1,39.2344,txt2,'fontsize',15,'fontweight','bold','fontname','微软雅黑','Color','k')
