...
path = 'C:\Users\酒仙桥科研巨擘专用\Desktop\.1 2021-08-27 12-58-22 0';           %添加数据文件夹绝对路径,工作区间要在同一个盘内
...
tem=(size(D,1))*11/20;%分成两个子矩阵，分别寻峰
D1=D(1:tem,:);
D2=D(tem:end,:);
hold on
...
%  cd('C:\Users\酒仙桥科研巨擘专用\Desktop\图');    %把当前工作目录切换到指定文件夹
%  f = getframe(gcf);
