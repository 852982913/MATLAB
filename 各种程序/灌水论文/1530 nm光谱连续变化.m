...
legend('Δλ = 2.65 nm','Δλ = 2.88 nm','Δλ = 3.20 nm','Δλ = 3.79 nm','Δλ = 4.08 nm','fontsize',15)
...
title('1530 nm谱宽连续变化','fontname','微软雅黑','fontsize',14,'FontWeight','bold','Color','r') 
xlim([1515 1550]);
ylim([-85 -35]);
