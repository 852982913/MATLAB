...
path = 'C:\Users\酒仙桥科研巨擘专用\Desktop\40001-1Hz\1913-2317';           %添加数据文件夹绝对路径,工作区间要在同一个盘内
...
%  cd('C:\Users\酒仙桥科研巨擘专用\Desktop\图图');    %把当前工作目录切换到指定文件夹
%  f = getframe(gcf);
